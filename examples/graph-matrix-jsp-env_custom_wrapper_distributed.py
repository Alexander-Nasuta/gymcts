...
from gymcts.gymcts_distributed_agent import DistributedGymctsAgent
...
if __name__ == '__main__':
    ...
    import time
    perfcounter1 = time.perf_counter()
    actions = agent.solve(render_tree_after_step=True)
    perfcounter2 = time.perf_counter()
    print(f"Time to solve: {perfcounter2 - perfcounter1}")
