...
class ExperimentWrapper(DeepCopyMCTSGymEnvWrapper, gym.Wrapper):
    ...
    def rollout(self) -> float:
        ...
        wb.log(
            {
                "num_timesteps": ExperimentWrapper.performed_timesteps,
                "makespan": self.env.unwrapped.get_makespan(),
                "visited_states": len(ExperimentMctsAgent.visited_states_set),
            }
        )
...
class ExperimentMctsAgent(GymctsAgent):
    ...
    def vanilla_mcts_search(self, search_start_node: GymctsNode = None, num_simulations=10) -> int:
        ...
        log.debug(f"Performed timesteps: {ExperimentWrapper.performed_timesteps}, "
